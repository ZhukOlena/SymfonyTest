...
//
//    #[ORM\OneToOne(mappedBy: 'user', cascade: ['persist', 'remove'])]
//    private ?UserPofile $userPofile = null;
//
...
//    }
//
//    public function getUserPofile(): ?UserPofile
//    {
//        return $this->userPofile;
//    }
//
//    public function setUserPofile(UserPofile $userPofile): static
//    {
//        // set the owning side of the relation if necessary
//        if ($userPofile->getUser() !== $this) {
//            $userPofile->setUser($this);
//        }
//
